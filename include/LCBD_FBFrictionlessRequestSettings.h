...
@class Facebook; // -Bobby error here FacebookFacebook
 ...
 */
@interface LCBD_FBFrictionlessRequestSettings : NSObject<LCBD_FBRequestDelegate> {
@private
    NSArray*            _allowedRecipients;
    LCBD_FBRequest*          _activeRequest;
    BOOL                _enabled;
}
