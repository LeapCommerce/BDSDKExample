...
@protocol LCBD_FBDialogDelegate;
...
@interface LCBD_FBDialog : UIView <UIWebViewDelegate> {
    id<LCBD_FBDialogDelegate> _delegate;
    ...
    LCBD_FBFrictionlessRequestSettings* _frictionlessSettings;
 ...
 * The delegate.
 */
@property(nonatomic,assign) id<LCBD_FBDialogDelegate> delegate;
...
- (id)initWithURL: (NSString *) loadingURL
  ...
  isViewInvisible: (BOOL) isViewInvisible
    frictionlessSettings: (LCBD_FBFrictionlessRequestSettings *) frictionlessSettings
         delegate: (id <LCBD_FBDialogDelegate>) delegate;
 ...
 */
@protocol LCBD_FBDialogDelegate <NSObject>
 ...
 */
- (void)dialogDidComplete:(LCBD_FBDialog *)dialog;
 ...
 */
- (void)dialogDidNotComplete:(LCBD_FBDialog *)dialog;

/**
 * Called when dialog failed to load due to an error.
 */
- (void)dialog:(LCBD_FBDialog*)dialog didFailWithError:(NSError *)error;
 ...
 */
- (BOOL)dialog:(LCBD_FBDialog*)dialog shouldOpenURLInExternalBrowser:(NSURL *)url;
